#! /usr/bin/python
'''Combine multiple xvgs to one file'''
...
def ProcessCommandLine():
    ...
    parser = argparse.ArgumentParser(description='''Combine multiple xvg files into one.

Reads all xvg files passed in cmdline and combines their data blocks. There should be
a single X column in each file, which (ideally) should match throughout.
''')
